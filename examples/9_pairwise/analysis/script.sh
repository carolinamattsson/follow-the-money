...
# for networks with a biting smallest limit, these options put lower and upper bounds on broken durations
...
# plus filtering on an ending timewindow
python3 ../../../analysis/trj_durations.py ../../9_pairwise/output/network_sm30000_pairs_mixed.csv ./ --prefix network_ --suffix _mixed_sm30000_min_end --column all --timewindow_end "2017-03-04 00:00:00"
python3 ../../../analysis/trj_durations.py ../../9_pairwise/output/network_sm30000_pairs_mixed.csv ./ --prefix network_ --suffix _mixed_sm30000_max_end --column all --timewindow_beg "2017-03-01 00:00:00" --timewindow_end "2017-03-04 00:00:00"